	...
	<div class="container">
		...
		<div class="row">
			<div id="portfolio-wrapper">
				<div class="row">
					<talks:talk talkDate="June 2012" title="SmartThings + Groovy = Vert.x" presenter="Ryan Applegate" presenterUrl="http://twitter.com/rappleg" url="http://slid.es/rappleg/vert-x" />
